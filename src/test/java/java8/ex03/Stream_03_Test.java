...
public class Stream_03_Test {
    ...
    public void test_joining() throws Exception {
        ...
        String result = customers.stream().map(c -> c.getFirstname()).sorted().reduce((name1, name2) -> name1+"|"+name2).get();
        //done
    ...
    public void test_partitionning() throws Exception {
        ...
        //pas d'exercice : corection dans l'énoncé
    ...
    public void test_mapping() throws Exception {
        ...
        Map<Gender, String> result = customers.stream().sorted((c1, c2) -> c1.getFirstname().compareTo(c2.getFirstname())).collect(
        		toMap((Customer c)-> c.getGender(), (Customer c)-> c.getFirstname(), (name1, name2) -> name1+"|"+name2));
        //done
